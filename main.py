...
# Battle GIF URLs
BATTLE_GIFS = {
    "wild": "https://media.tenor.com/S2Z3bScPjJ0AAAAC/pokemon-battle.gif",
    "pvp": "https://media.tenor.com/m7bER1iYmfAAAAAC/pokemon-battle.gif",
    "loading": "https://media.tenor.com/tKFAQN4E-j8AAAAC/pokeball-pokemon.gif"
}
...
class PokemonSelectModal(discord.ui.Modal, title="Select Your Pokémon"):
    ...
    async def start_pvp_battle(self, interaction: discord.Interaction, challenger_pokemon: dict, opponent_pokemon: dict):
        ...
        battle_embed = discord.Embed(
            ...
            description="The Pokémon are fighting!",
            color=Colors.DANGER
        )
