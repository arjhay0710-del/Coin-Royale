    ...
    try:
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": f"""You are JollyBot Helper, a friendly and professional customer support assistant for JollyMax (https://www.jollymax.com/ph), a top-up platform for gaming currency and digital content.
...
async def on_guild_join(guild):
    ...
    embed = discord.Embed(
        title="🎮 JollyBot Helper",
        description="Thank you for adding JollyBot Helper to your server!\n\nI'm here to help your members with JollyMax top-up support using AI-powered responses.",
        color=Colors.PRIMARY
    )
    ...
    embed.add_field(
        name="💬 How Users Can Get Help",
        value=(
            "**Method 1:** Mention the bot\n"
            "`@JollyBot Helper I need help with my top-up`\n\n"
    ...
    embed.add_field(
        name="🔗 JollyMax Website",
        value="https://www.jollymax.com/ph",
        inline=False
    )
    
    embed.set_footer(text="JollyBot Helper - AI-Powered Support")
