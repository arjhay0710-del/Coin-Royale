...
@tree.command(name="announcement", description="📢 Send an announcement to a channel")
...
async def announcement(
    ...
    """Send an announcement to specified channel"""
    ...
    if image:
        try:
            announcement_embed.set_image(url=image)
        except:
            pass
    ...
    try:
        ...
        confirm_embed = discord.Embed(
            ...
            description=f"Successfully sent announcement to {channel.mention}",
            color=Colors.SUCCESS
        )
        await interaction.followup.send(embed=confirm_embed, ephemeral=True)
        
        logging.info(f"📢 Announcement sent by {interaction.user.name} in {interaction.guild.name} to #{channel.name}")
...
async def help_command(interaction: discord.Interaction):
    ...
    if interaction.user.guild_permissions.administrator:
        embed.add_field(
            name="🔧 Admin Commands",
            value=(
                "`/announcement` - Send announcements to any channel\n"
        ...
        embed.add_field(
            ...
            value="```/announcement channel:#general text:Hello everyone! image:https://example.com/image.png```",
            inline=False
        )
