...
@tree.command(name="balance", description="💰 Tan-awon pila imo coins")
...
@tree.command(name="transfer", description="💸 Hatag coins sa lain")
@app_commands.describe(
    user="Ang user nga hatagan",
    amount="Pila ka coins"
)
...
@app_commands.describe(amount="Pila ibutang")
...
@tree.command(name="stats", description="📊 Tan-awa imo game statistics")
